...
data class ElementDeserializer(
  ...
  fun deserialize(
    ...
    else -> deserializer.fold(
      { context.handleUnexpectedToken(javaType.rawClass, token, parser, "no deserializer was found for given type") },
      { deserializer ->
